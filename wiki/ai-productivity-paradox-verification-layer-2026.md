...
- [`wiki/aiengineeringskillsmap-softwareengineeringfundamentals.md`](aiengineeringskillsmap-softwareengineeringfundamentals.md) – Andrew Ng: agents supply the "how", humans the "why"; you must still verify generated code
- [`wiki/michael-bolton-systems-thinking-constraints-2026.md`](michael-bolton-systems-thinking-constraints-2026.md) – Bolton: constraints are the bottle's neck, not a bottleneck; perturb the system to find hidden defects
