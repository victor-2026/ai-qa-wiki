...
3. Kata-среда = удобная плоскость для mutation: сломай парсер → выживший тест = зона риска. (Agentiqa/flow-based analogy: parser - детерминированная составляющая AI-пайплайна.)
